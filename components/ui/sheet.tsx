  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-card data-[state=open]:animate-in data-[state=closed]:animate-out fixed inset-y-0 z-50 flex h-full w-full flex-col gap-4 border-l p-6 shadow-lg duration-300 sm:max-w-md",
          side === "right"
