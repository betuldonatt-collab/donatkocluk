...
// School -> Task 2). Never gradeable though: no status checkbox, no D/Y/B
// stats (see student_events / 0066_student_events.sql,
// 0067_student_events_order_index.sql).
export function EventCard({
  ...
  return (
    <div ref={setNodeRef} style={style} className={cn("flex flex-col gap-1 rounded-md border px-2 py-1.5 text-xs", EVENT_TYPE_CLASSES[event.event_type])}>
