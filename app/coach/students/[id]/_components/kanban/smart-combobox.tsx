...
// regardless of case or Turkish diacritics (see normalizeTr). Built by
// hand rather than pulling in cmdk/Popover since the rest of this app's
// dropdowns are all hand-rolled too.
