...
// point; when that point is also the series max (yAt(max) === PAD.top),
// a 16px top pad left the label's own height with nowhere to go but
// above y=0, clipped by the viewBox (matches the same fix already
// applied to the student panel's own copy of this chart).
...
// Single-metric trend line, shared by any page that just needs one series
// over time (currently: Genel Deneme Analizi's overall Net trend).
